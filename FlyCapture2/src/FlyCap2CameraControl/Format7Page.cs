...
namespace FlyCap2CameraControl
{
    ...
    internal partial class Format7Page : BasePage
    {
        ...
        private readonly PersistentSettings m_settings = PersistentSettings.Instance;
        ...
        public Format7Page(ManagedCameraBase initialCamera)
        {
            ...
            // SDK-2266 - Apply preset settings to use Max Image Size
            if (m_settings.EnableSettings)
            {
                if (m_settings.CustomVideoModePersistentSettings.UseMaxImageSize)
                {
                    UseMaxImageSize();
                }
            }
