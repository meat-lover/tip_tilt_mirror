...
namespace FlyCap2CameraControl
{
    ...
    internal partial class CameraSettingsPage : BasePage
    {
        ...
        private PersistentSettings m_settings = PersistentSettings.Instance;
        ...
        private int InitialzePropertyControlsWithTrackbar(int controlPositionY)
        {
            ...
            // SDK-2266 - Apply preset settings for brightness and frame rate
            if (m_settings.EnableSettings)
            {
                this.m_properties[0].SetCameraProperty(
                    m_settings.BrightnessPersistentSettings.Value,
                    m_settings.BrightnessPersistentSettings.AutoMode,
                    m_settings.BrightnessPersistentSettings.AbsControl);

                this.m_properties[13].SetCameraProperty(
                    m_settings.FrameRatePersistentSettings.Value,
                    m_settings.FrameRatePersistentSettings.AutoMode,
                    m_settings.FrameRatePersistentSettings.AbsControl);
            }
