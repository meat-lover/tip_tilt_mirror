...
namespace FlyCapture2
{
    ...
    sigc::signal<void, unsigned int, unsigned int, unsigned int, unsigned int, bool> Format7DrawingArea::signal_image_size_changed()
    {
        return m_signal_image_size_changed;
    }

    sigc::signal<void> Format7DrawingArea::signal_drawing_area_pressed()
    {
        return m_signal_drawing_area_pressed;
    }
        ...
        else
        {
            ...
            if (m_imageSizeChanged == true)
            {
                    ...
                    m_height != m_lastFiredHeight)
                {
                    ...
                    m_signal_image_size_changed(m_left, m_top, m_width, m_height, m_rightMBHeld);
